...
M<-readRDS("Seurat_Liver_30_subcluster_CD4.rds")

# Add cluster names
cluster_names=c("CD8 Effector T", #0
                "CD56bright NK", #1
                ...
                "CD4 Activated T", #22
                "CD4 TCM") #23
M@meta.data[["cluster_names_new"]] <- mapvalues(M@meta.data[["subcluster_21"]], from=0:23, to=cluster_names)
...
cluster_names_redu=c("CD8T", #0
                     ...
                     "CD4T", #22
                     "CD4T") #23
M@meta.data[["cluster_names_new_redu"]] <- mapvalues(M@meta.data[["subcluster_21"]], from=0:23, to=cluster_names_redu)
