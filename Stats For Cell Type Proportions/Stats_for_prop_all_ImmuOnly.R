...
# Subset down to only immune cells
Idents(M)<-"cluster_names_new_redu"
M<-subset(M, idents=c("CD8T", "Plasma", "Kupffer", "pDC", "CD4T", "B", "Monocyte-Derived Macrophage", "NK", "Gamma Delta T"))
...
pdf("/data/GI-Informatics/DePasquale/Projects/Peters_5PrimeTCRBCR/Seurat_Integration_0.5_SCT_08.30.23/Stats_for_prop_CD8T_Immu.pdf", width = 6, height = 6)
...
dir.create("/data/GI-Informatics/DePasquale/Projects/Peters_5PrimeTCRBCR/Seurat_Integration_0.5_SCT_08.30.23/Stat_Prop_Immu")
setwd("/data/GI-Informatics/DePasquale/Projects/Peters_5PrimeTCRBCR/Seurat_Integration_0.5_SCT_08.30.23/Stat_Prop_Immu")
