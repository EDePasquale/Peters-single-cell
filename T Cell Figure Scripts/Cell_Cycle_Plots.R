...
Clusters_Keep=c("CD8 Effector Memory T", "CD4 Naïve T", "CD4 Activated T","CD4 TEMRA", "CD8 NK-like T", "Gamma Delta T", "MAIT", "CD8 Effector T", "Cycling T")
...
P1<-FeaturePlot(M_T, reduction="tsne", features = "G2M.Score",min.cutoff = 0)
P2<-FeaturePlot(M_T, reduction="tsne", features = "S.Score", min.cutoff = 0)
