...
pdf(file = "Kupffer_Manual_RNA_DotPlot_Names.pdf", width = 10, height = 5)
par(mar=c(4, 4, 4, 4))
DotPlot(object=M_K, assay="RNA", features = myGenes, dot.scale=10, scale=F) + labs(y ="Cluster", x=NULL)
dev.off()
